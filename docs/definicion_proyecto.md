# Documento de Definición del Proyecto: Aria Training (v1.7)
...
| 1.6 | 2025-12-11 | Fernando Botero | **Revolución de UX y Vista de Atleta.** 1. **Modo Oscuro Nativo:** Implementación completa con persistencia y toggle en UI. 2. **Gestión de Rutinas Avanzada:** Editor con Drag & Drop (SortableJS) para bloques y ejercicios, calendario interactivo y tarjetas inteligentes. 3. **Vista de Atleta Mobile-First:** Dashboard dedicado y sesión de entrenamiento en tiempo real con registro de series, RPE/RIR y feedback inmediato. 4. **Arquitectura de Datos:** Actualización del esquema (13 tablas) incluyendo soporte para bloques y registro detallado. |
| **1.7** | **2025-12-11** | **Fernando Botero** | **Fase 2: Administración Avanzada y Arquitectura.** 1. **Impersonation:** Admins pueden iniciar sesión como cualquier usuario para soporte técnico. 2. **Command Palette (Ctrl+K):** Búsqueda global y navegación rápida por teclado. 3. **Gestión de Avatares:** Subida de fotos de perfil con fallback a UI Avatars. 4. **Reseteo de Contraseña:** Admins pueden restablecer contraseñas desde la UI con generador aleatorio. 5. **Service Layer:** Refactorización a UserService y RutinaService para centralizar lógica de negocio, mejorando testabilidad y mantenimiento. 6. **Correcciones:** Múltiples errores de sintaxis Blade resueltos. |

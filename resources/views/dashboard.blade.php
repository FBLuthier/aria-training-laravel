    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 auto-rows-[minmax(180px,auto)]">
                ...
                {{-- Tarjeta 3: Gestión de Ejercicios --}}
                <a href="{{ route('admin.ejercicios') }}" class="block p-6 bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg hover:shadow-md transition-shadow duration-300 border-l-4 border-purple-500">
                ...
                {{-- Card: Rutinas (Orange style) --}}
                <a href="{{ route('admin.rutinas') }}" class="col-span-1 md:col-span-1 lg:col-span-1 bg-white dark:bg-zinc-900 rounded-3xl p-8 border border-gray-100 dark:border-zinc-800 hover:border-orange-500/30 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl group">
                    <div class="w-12 h-12 bg-orange-100 dark:bg-orange-900/30 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">

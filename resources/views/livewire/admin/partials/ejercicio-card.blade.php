<div wire:key="re-{{ $re->id }}" class="border border-gray-200 dark:border-gray-700 rounded-lg p-3 bg-gray-50 dark:bg-gray-700/50 hover:bg-white dark:hover:bg-gray-800 transition-colors">
    <div class="flex flex-col gap-3">
        ...
        <div class="flex items-center gap-3">
            ...
            {{-- Eliminar --}}
            <button wire:click="removeEjercicio({{ $re->id }})" class="text-gray-400 hover:text-red-500 transition-colors p-1 self-start mt-1" title="Eliminar Ejercicio">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path></svg>
            </button>
        </div>

        {{-- Row 2: Métricas (Spacious) --}}
        <div class="flex items-center gap-4">
            ...
            <div class="w-16">
                <input type="text" 
                       ...
                       class="no-drag block w-full py-1 text-xs rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 focus:ring-indigo-500 text-center"
                       placeholder="Reps"
                       title="Repeticiones"
                >
            </div>
            ...
            <div class="w-32 relative">
                <input type="text" 
                       ...
                       class="no-drag block w-full py-1 text-xs rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 focus:ring-indigo-500 pr-12
                ...
                <div class="absolute inset-y-0 right-0 flex items-center bg-white dark:bg-gray-900 rounded-r-md border-l border-gray-300 dark:border-gray-700">
                    <select wire:model.live="ejerciciosData.{{ $re->id }}.unidad_peso"
                            ...
                            class="no-drag h-full py-0 pl-1 pr-6 text-[10px] border-0 bg-transparent text-gray-500 focus:ring-0"
                    >
            ...
            {{-- RPE / RIR --}}
            <div class="flex items-center gap-3 border-l border-gray-200 dark:border-gray-600 pl-4">

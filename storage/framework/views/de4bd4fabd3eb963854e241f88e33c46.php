...
<?php $component->withAttributes(['align' => 'right','width' => '48']); ?>
                     <?php $__env->slot('trigger', null, []); ?> 
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none transition ease-in-out duration-150">
                            <div><?php echo e(Auth::user()->nombre_1); ?> <?php echo e(Auth::user()->apellido_1); ?></div>
...
<?php endif; ?>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            <div class="px-4">
                <div class="font-medium text-base text-gray-800 dark:text-gray-200"><?php echo e(Auth::user()->nombre_1); ?> <?php echo e(Auth::user()->apellido_1); ?></div>
                <div class="font-medium text-sm text-gray-500"><?php echo e(Auth::user()->correo); ?></div>
            </div>
...
<?php /**PATH C:\xampp\htdocs\aria-training\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>
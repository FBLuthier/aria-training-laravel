...
<div 
    <?php echo e($attributes->merge(['class' => 'fixed inset-0 z-50 flex items-center justify-center bg-gray-900/50 dark:bg-gray-950/70'])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.spinner','data' => ['size' => 'xl','color' => 'primary']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['size' => 'xl','color' => 'primary']); ?>
...
<?php endif; ?>
        <p class="text-gray-700 dark:text-gray-300 font-medium"><?php echo e($message); ?></p>
    </div>
</div>
<?php /**PATH C:\xampp\htdocs\aria-training\resources\views/components/loading-overlay.blade.php ENDPATH**/ ?>
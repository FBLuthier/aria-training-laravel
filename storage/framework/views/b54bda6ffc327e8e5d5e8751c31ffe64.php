                            ...
                            <tr class="bg-gray-50 dark:bg-zinc-800/50">
                                <td colspan="7" class="px-6 py-4">
                                    <div class="space-y-4">
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if($log->action === 'create'): ?>
                                            <div>
                                                <pre class="bg-gray-100 dark:bg-zinc-900 p-3 rounded text-sm overflow-x-auto dark:text-gray-300"><?php echo e(json_encode($log->new_values, JSON_PRETTY_PRINT)); ?></pre>
                                            </div>
                                        <?php elseif($log->action === 'update'): ?>
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                <div>
                                                    <pre class="bg-red-50 dark:bg-red-900/20 p-3 rounded text-sm overflow-x-auto dark:text-red-200"><?php echo e(json_encode($log->old_values, JSON_PRETTY_PRINT)); ?></pre>
                                                </div>
                                                <div>
                                                    <pre class="bg-green-50 dark:bg-green-900/20 p-3 rounded text-sm overflow-x-auto dark:text-green-200"><?php echo e(json_encode($log->new_values, JSON_PRETTY_PRINT)); ?></pre>
                                                </div>
                                            </div>
                                        <?php elseif($log->action === 'delete'): ?>
                                            <div>
                                        ...
                                        <?php elseif($log->action === 'restore'): ?>
                                            <div>
                                                <pre class="bg-purple-50 dark:bg-purple-900/20 p-3 rounded text-sm overflow-x-auto dark:text-purple-200"><?php echo e(json_encode($log->new_values, JSON_PRETTY_PRINT)); ?></pre>
                                            </div>
                                        <?php elseif($log->action === 'force_delete'): ?>
                                            <div>
                                                <pre class="bg-red-50 dark:bg-red-900/20 p-3 rounded text-sm overflow-x-auto dark:text-red-200"><?php echo e(json_encode($log->old_values, JSON_PRETTY_PRINT)); ?></pre>
    ...
    <div class="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="bg-white dark:bg-zinc-900 rounded-lg shadow-md p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <div class="text-2xl font-semibold text-gray-900 dark:text-white"><?php echo e($auditLogs->total()); ?></div>
        ...
        <div class="bg-white dark:bg-zinc-900 rounded-lg shadow-md p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <div class="text-2xl font-semibold text-gray-900 dark:text-white"><?php echo e($auditLogs->count()); ?></div>
        ...
        <div class="bg-white dark:bg-zinc-900 rounded-lg shadow-md p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <div class="text-2xl font-semibold text-gray-900 dark:text-white"><?php echo e(now()->format('d/m/Y H:i')); ?></div>

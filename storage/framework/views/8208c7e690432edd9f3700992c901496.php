...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['wire:model.live' => 'search','class' => 'block w-full','type' => 'text','placeholder' => 'Buscar rutina...']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:model.live' => 'search','class' => 'block w-full','type' => 'text','placeholder' => 'Buscar rutina...']); ?>

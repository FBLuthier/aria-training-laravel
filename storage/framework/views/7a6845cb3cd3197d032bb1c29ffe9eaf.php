...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['loadingTarget' => null]));
...
foreach (array_filter((['loadingTarget' => null]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.spinner','data' => ['size' => 'sm','color' => 'white','wire:loading' => true,'wire:target' => ''.e($loadingTarget).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['size' => 'sm','color' => 'white','wire:loading' => true,'wire:target' => ''.e($loadingTarget).'']); ?>
...
<?php /**PATH C:\xampp\htdocs\aria-training\resources\views/components/danger-button.blade.php ENDPATH**/ ?>
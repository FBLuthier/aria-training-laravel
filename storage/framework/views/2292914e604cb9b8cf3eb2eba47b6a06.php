...
<?php $component->withAttributes([]); ?>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <h3 class="text-3xl font-bold text-gray-900 dark:text-white">Bienvenido, <?php echo e(Auth::user()->name); ?></h3>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 auto-rows-[minmax(180px,auto)]">
                ...
                <a href="<?php echo e(route('admin.usuarios.index')); ?>" class="col-span-1 md:col-span-2 lg:col-span-2 bg-white dark:bg-zinc-900 rounded-3xl p-8 border border-gray-100 dark:border-zinc-800 hover:border-orange-500/30 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl group relative overflow-hidden">
                ...
                <a href="<?php echo e(route('admin.equipos.index')); ?>" class="col-span-1 md:col-span-1 lg:col-span-1 bg-white dark:bg-zinc-900 rounded-3xl p-8 border border-gray-100 dark:border-zinc-800 hover:border-blue-500/30 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl group">

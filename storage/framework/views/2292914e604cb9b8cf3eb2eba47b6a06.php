...
<?php $component->withAttributes([]); ?>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <h3 class="text-3xl font-bold text-gray-900 dark:text-white">Bienvenido, <?php echo e(Auth::user()->nombre_1); ?>.</h3>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <a href="<?php echo e(route('admin.usuarios.index')); ?>" class="group relative p-6 bg-white dark:bg-zinc-900 border border-gray-100 dark:border-zinc-800 rounded-2xl hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                ...
                <a href="<?php echo e(route('admin.ejercicios')); ?>" class="group relative p-6 bg-white dark:bg-zinc-900 border border-gray-100 dark:border-zinc-800 rounded-2xl hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                    <div class="flex items-center justify-between mb-4">
                ...
                <!-- Card: Rutinas (Indigo) -->
                <a href="<?php echo e(route('admin.rutinas')); ?>" class="group relative p-6 bg-white dark:bg-zinc-900 border border-gray-100 dark:border-zinc-800 rounded-2xl hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                    <div class="flex items-center justify-between mb-4">
                ...
                <!-- Card: Equipos (Blue) -->
                <a href="<?php echo e(route('admin.equipos.index')); ?>" class="group relative p-6 bg-white dark:bg-zinc-900 border border-gray-100 dark:border-zinc-800 rounded-2xl hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                    <div class="flex items-center justify-between mb-4">
                ...
                <a href="<?php echo e(route('admin.auditoria.index')); ?>" class="group relative p-6 bg-white dark:bg-zinc-900 border border-gray-100 dark:border-zinc-800 rounded-2xl hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                    <div class="flex items-center justify-between mb-4">
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\aria-training\resources\views/dashboard.blade.php ENDPATH**/ ?>